...
public class BiomeKatharianSwamps extends BiomeKatharianBiomeBase {
    ...
    public BiomeKatharianSwamps() {
        ...
        //this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(Feature.BUSH, new BushConfig(ModBlocks.KATHAIRIS_TALL_GRASS.getDefaultState()), Placement.COUNT_HEIGHTMAP, new FrequencyConfig(5)));
        //this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createDecoratedFeature(Feature.BUSH, new BushConfig(ModBlocks.KATHAIRIS_MINI_GRASS.getDefaultState()), Placement.COUNT_HEIGHTMAP, new FrequencyConfig(3)));
